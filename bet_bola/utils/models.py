...
class Entry(models.Model):
    creator_user = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, related_name="my_created_entries", on_delete=models.CASCADE, verbose_name='Quem gerou o lançamento')
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="my_entries", on_delete=models.CASCADE, verbose_name='Cambista')
...
class GeneralConfigurations(models.Model):
    ...
    add_league_to_ticket_print = models.BooleanField(default=False, verbose_name="Adicionar ligas nos envios do bilhete?")
    add_link_to_ticket_whats = models.BooleanField(default=True, verbose_name="Adicionar link do bilhete ao envio do whatsapp?")
    tomorrow_games_available = models.BooleanField(default=True, verbose_name="Disponibilizar jogos de amanhã?")
    after_tomorrow_games_available = models.BooleanField(default=True, verbose_name="Disponibilizar jogos de depois de amanhã?")
    separate_gross_and_net_value = models.BooleanField(default=False, verbose_name="Separar Bruto do Líquido")
...
class PercentualStandardCotation(models.Model):
    home_percentual = models.IntegerField(null=True, verbose_name="Percentual Casa")
    tie_percentual = models.IntegerField(null=True, verbose_name="Percentual Empate")
    away_percentual = models.IntegerField(null=True, verbose_name="Percentual Fora")
