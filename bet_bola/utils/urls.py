...
from utils.views.percentual_standard_cotation import PercentualStandardCotationView
...
router.register(r'percentual_standard_cotation', PercentualStandardCotationView)
