...
class MarketModifiedView(ModelViewSet):
    ...
    def create(self, validated_data):
        ...
        invalidate_cache_group(['/market_cotations/', '/get_cotations_by_market/'], self.request.user.my_store.pk) 
...
class MarketRemotionView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        self.perform_create(serializer)                
        headers = self.get_success_headers(serializer.data)
        invalidate_cache_group(['/market_cotations/', '/get_cotations_by_market/'], request.user.my_store.pk) 
