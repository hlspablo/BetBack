...
class ManagerSerializer(serializers.HyperlinkedModelSerializer):
	...
	class Meta:
		model = Manager
		fields = ('id','username','first_name','password','cpf',
		'cellphone','address', 'email','can_cancel_ticket','can_modify_seller',
		'can_modify_seller_comissions','limit_time_to_cancel','can_sell_unlimited',
		'credit_limit','can_change_limit_time','comission_based_on_profit','can_close_cashier',
		'is_active', 'can_add_entry')
